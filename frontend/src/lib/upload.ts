...
// tying up the 512MB API instance — and so the "max 20 MB" we show in the UI is the same number
...
// cap would 413 the upload long before this 20 MB limit ever mattered.

...
export const packAssignmentSchema = z
  .object({
    ...
    auto_assigned: z.boolean().optional().default(false),
    ...
    locked_by_name: z.string().nullable().optional().default(null),
    estimated_minutes: z.number().nullable().optional().default(null),
    pass_pct: z.number().nullable().optional().default(null),
